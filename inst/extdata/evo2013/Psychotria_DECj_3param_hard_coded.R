...
# Run the ML search
results_object = bears_3param_standard_fast(trfn, geogfn)
#results_object2 = bears_3param_standard_fast(trfn="Psychotria_5.2.newick", geogfn="Psychotria_geog.data")
...
title("Hawaiian Psychotria, DEC 2-parameter, marginal ML states")
